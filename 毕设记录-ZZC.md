...
![mysql启动失败](毕设记录-ZZC.assets\1552813791289.png)

使用sudo /usr/local/mysql/support-files/mysql.server restart启动可以看到详细错误原因：

![启动失败详细原因](毕设记录-ZZC.assets\1552813835864.png)
...
![不能直接使用mysql命令](毕设记录-ZZC.assets\1552813530751.png)
...
![php-fpm.conf](毕设记录-ZZC.assets\1552830266267.png)
...
![添加](毕设记录-ZZC.assets\1552831442649.png)

去掉注释

![去掉注释](毕设记录-ZZC.assets\1552831520762.png)

修改内容

![修改内容](毕设记录-ZZC.assets\1552831559428.png)
...
![PHP测试页面](毕设记录-ZZC.assets\1552831742280.png)
